...
export default function Services() {
  return (
    <div
      className={`bg-white flex md:flex-row flex-col ${out.className} space-x-10 w-full  min-h-full py-12 justify-center items-center`}
    >
      ...
      <div className="flex flex-col space-y-8">
        <div className="border-l-2 hover:bg-[#EFDFEF] rounded-r-lg border-black px-6">
